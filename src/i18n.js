...
export const i18n = {
  ...
  en: {
    ...
    about: {
      ...
      p3: '⚠️ The model can produce <strong>hallucinations</strong> — made-up words — especially on short or unusual input. This is a known limitation of the original HiTZ model. <strong>Auto-correct is not AI-based</strong>: it uses a static 160k-word dictionary and Levenshtein distance, not machine learning or LLM technology.',
    },
    pipeline: {
      audio: '🎤 Audio',
      asr: 'Parakeet-eu ASR',
